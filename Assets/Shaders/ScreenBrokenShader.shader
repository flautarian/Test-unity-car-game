Shader "Custom/RenderImage/ScreenBroken" {
	Properties{
		...
		SubShader{
			...
			//The definition of this part of parameters should be based on Properties
			fixed4 _Color;
			sampler2D _MainTex;
			float4 _MainTex_ST;
			...
			//The output part should correspond to the input part, and the output part must be determined by the calculation model in the fragment shader
			struct v2f {
